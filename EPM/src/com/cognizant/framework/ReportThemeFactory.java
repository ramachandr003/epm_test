...
public class ReportThemeFactory
{
	...
	public enum Theme
	{
		CLASSIC, MYSTIC, AUTUMN, OLIVE, REBEL, RETRO, SERENE, EPM
	}
	...
	public static ReportTheme getReportsTheme(Theme theme)
	{
		...
		case REBEL:
			reportTheme.setHeadingBackColor("#EEEEEE");
		...
		case SERENE:
			...
			break;
		case EPM:
			reportTheme.setHeadingBackColor("#DDDDDD");
			reportTheme.setHeadingForeColor("#990033");
			reportTheme.setSectionBackColor("#CCCCCC");
			reportTheme.setSectionForeColor("#004B91");
			reportTheme.setContentForeColor("#004B91");
